...
class menu:
    ...
    def book(self):
        ...
        l3=Button(self.a,text='Buy Books',font='Papyrus 22 bold',fg='Orange',bg='Black',width=15,padx=10,command=self.buybook).place(x=12,y=400)
    ...
    def buybook(self):
        ...
        self.f1=Frame(self.a,height=500,width=650,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book Name:',font='Papyrus 12 bold',fg='Orange',bg='Black',pady=1).place(x=50,y=50)
        e1=Entry(self.f1,width=45,bg='orange',fg='black',textvariable=self.n).place(x=150,y=50)
        b1=Button(self.f1,text='Go',font='Papyrus 10 bold',fg='black',bg='orange',width=15,bd=3,command=self.goweb).place(x=150,y=400)
        b2=Button(self.f1,text='Back',font='Papyrus 10 bold',fg='black',bg='orange',width=15,bd=3,command=self.rm).place(x=350,y=400)
    def goweb(self):
        name=self.n.get()
        self.URL='https://www.amazon.in/s?k='+name+'&ref=nb_sb_noss'
        webbrowser.open(self.URL)
        self.addbook()
        print("bought book :"+name)
    def rm(self):
        self.f1.destroy()
    def mainmenu(self):
        self.root.destroy()
    ...
    def serch1(self):
        ...
        print("searched detail of studentid="+k)
    ...
    def issuedbook(self):
        ...
        print("Issued book id="+bookid+" to student id="+studentid)
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('ADMIN', '123')")
        conn.commit()
